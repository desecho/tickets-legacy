...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.no_connection'
        db.add_column(u'tickets_team', 'no_connection',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Team.no_connection'
        db.delete_column(u'tickets_team', 'no_connection')
